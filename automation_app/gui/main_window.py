...
from automation_app.core.macro_engine import MacroEngine
from automation_app.core.macro_recorder import MacroRecorder
from automation_app.core.macro_store import MacroStore
from automation_app.core.models import Macro, MacroGroup, Trigger
from automation_app.core.trigger_system import TriggerSystem
from automation_app.gui.group_manager import GroupManager
from automation_app.gui.macro_editor import MacroEditor
from automation_app.modules.image_detection import ImageDetector


class MainWindow(QMainWindow):
    def __init__(self, store: MacroStore) -> None:
        super().__init__()
        self.setWindowTitle("Macro Automation App")
